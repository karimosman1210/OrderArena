...
public class UserOrderMarketViewHolder extends RecyclerView.ViewHolder {
    ...
    public UserOrderMarketViewHolder(View itemView) {
        super(itemView);
    ...
    public void updateView(Order order) {
        ...
        DataService.getInstance().getMarket(order.getRestId(), new DataListeners.HyperMarketListener() {
